...
Restart:
    ...
    End With
        ...
        End With
            ...
            With MainFrame.Table
                .BuildTable SplitRow, 100
                .AddTableProgressBars
                .AddSubTableProgressBars
            End With
...
'---------------------------------------------------------------
Public Function GetActiveList(ScreenPage As enScreenPage, SortBy As String) As Recordset
    ...
    If SortBy <> "" Then StrSortBy = "ORDER BY " & SortBy
    If SortBy = "Progress" Then StrSortBy = StrSortBy & " DESC"
    ...
    Select Case ScreenPage
        Case enScrProjForAction
            SQL1 = "Select " _
                 ...
                 & "Where "
            SQL2 = "    ((TblWorkflow.RAG) = 'en1Red' And " _
                 & "        (TblWorkflow.WorkflowType) = 'enProject') Or " _
                 & "    ((TblWorkflow.RAG) = 'en2Amber' And " _
                 & "        (TblWorkflow.WorkflowType) = 'enProject') Or " _
                 & "    ((TblWorkflow.RAG) = 'en3Green' And " _
                 & "        (TblWorkflow.WorkflowType) = 'enProject' And " _

...
End
Attribute VB_Name = "FrmAdnWFTypes"
...
Private Const StrMODULE As String = "FrmAdnWFTypes"
Public Event CreateNew()
Public Event Update(WFNo As String)
Public Event Delete(WFNo As String)
...
Private Sub BtnDelete_Click()
    ...
    Response = MsgBox("Are you sure you want to delete the Workflow Type from the database?", vbYesNo + vbExclamation, APP_NAME)

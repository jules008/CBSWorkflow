...
Public Const GRAPH_2_COL_4 As Long = COL_BROWN
Public Const GRAPH_2_COL_5 As Long = COL_ORANGE
Public Const GRAPH_2_COL_6 As Long = COL_MAUVE
Public Const GRAPH_2_BACK_COL As Long = COL_WHITE
...
Public Const GRAPH_3_COL_4 As Long = COL_BROWN
Public Const GRAPH_3_COL_5 As Long = COL_ORANGE

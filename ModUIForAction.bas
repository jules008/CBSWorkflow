...
Public Function RefreshList(Optional SortBy As String) As Boolean
    ...
    With MainFrame
        ...
        ReDim RowTitles(0 To FOR_ACTION_Cell_NOCOLS - 1)
        RowTitles = Split(FOR_ACTION_Cell_TITLES, ":")

        For i = 0 To FOR_ACTION_Cell_NOCOLS - 1
